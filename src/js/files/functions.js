	...
	if (document.querySelector(".icon-menu")) {
		document.addEventListener("click", function (e) {
			if (bodyLockStatus && e.target.closest('.icon-menu')) {
				...
				// const subMenu = document.querySelector('.sub-menu-catalog__block') ? document.querySelector('sub-menu-catalog__block') : null;
				// if (subMenu && subMenu.classList.contains("_sub-menu-open")) {
